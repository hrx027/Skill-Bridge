      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between gap-8">
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-serif text-lg">Skill Bridge</span>
            </div>
            <p className="text-sm text-muted-foreground max-w-xs">
              Helping people navigate their careers with clarity and confidence.
            </p>
          </div>
          ...
          <div className="flex flex-wrap gap-12">
            <div>
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                ...
                <li><a href="#" className="hover:text-foreground transition-colors">For mentors</a></li>
              </ul>
            </div>
            <div>
        ...
        <div className="mt-12 pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-muted-foreground">
            2026 Skill Bridge. Crafted with care.
          </p>
